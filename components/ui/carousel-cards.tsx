...
export const Card = ({
  ...
  return (
    <>
      <motion.div
        layoutId={layout ? `card-layout-${index}` : undefined}
        className="h-80 w-56 sm:h-[40rem] sm:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10"
      >
